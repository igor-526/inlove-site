...
export function ContactSection({ address, nearestStop, coordinates, mapsUrl, phone, workingHours, socialLinks, ctaLabel, context, trimBottom = false, onRequest }: { address?: string; nearestStop?: string; coordinates?: { lat: number; lng: number }; mapsUrl?: string; phone?: string; workingHours?: string; socialLinks: SocialLink[]; ctaLabel: string; context: string; trimBottom?: boolean; onRequest: (context: string) => void }) {
